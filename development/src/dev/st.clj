...
;;    :starfleet/rank :starfleet.rank/captain
;;    :ns/favourite-drink "Tea: Early Grey, hot."})

;; (def riker
;;   {:xt/id :riker
;;    :person/name "William T Riker"
;;    :starfleet/rank :starfleet.rank/commander})

;; (def data
;;   {:xt/id :data
;;    :person/name "Data"
;;    :starfleet/rank :starfleet.rank/lt-commander})

;; (def enterprise-d
;;   {:xt/id :ncc-1701-d
;;    :ship/name "USS Enterprise"
;;    :ship/designation "NCC-1701-D"
;;    :ship/crew [:picard :riker]})

;; (def rank-captain
;;   {:xt/id :starfleet.rank/captain
;;    :starfleet.rank/description "Captain"})

;; (def rank-commander
;;   {:xt/id :starfleet.rank/commander
;;    :starfleet.rank/description "Commander"})

;; (def rank-lt-commander
;;   {:xt/id :starfleet.rank/lt-commander
;;    :starfleet.rank/description "Lt. Commander"})

;; (xt/submit-tx
;;  db/node (vec (for [doc [enterprise-d
;;                          picard riker data
...
;; (xt/q (xt/db db/node)
;;       '{:find [(pull cm [*])]
;;         :where [[uss-e :ship/name "USS Enterprise"]
;;                 [uss-e :ship/crew cm]
;;                 [cm :person/name name]
;;                 [cm :starfleet/rank rank-id]
;;                 ;; [cm :person/name "Jean-Luc Picard"]
;;                 (not [cm :ns/favourite-drink])
;;                 [rank :xt/id rank-id]
;;                 [rank :starfleet.rank/description rank-desc]]})

;; (xt/q (xt/db db/node)
;;       '{:find [(pull uss-e [* {:ship/crew [*]}])]
;;         :where [[uss-e :ship/name "USS Enterprise"]]})
...
;; (xt/entity (xt/db db/node) :commodity/Pu)
...
;; (xt/submit-tx db/node (for [doc my-docs]
;;                         [:xtdb.api/put doc]))

;; (xt/entity (xt/db db/node) -219)

;; (xt/q (xt/db db/node) '{:find [name]
;;                         :where [[actor :person/name name]
;;                                 [actor :person/born dob]
;;                                 [ss :person/name "Sylvester Stallone"]
;;                                 [ss :person/born ss-dob]
;;                                 [(< dob ss-dob)]]})
